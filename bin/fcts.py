...
def get_starting_pos(player):
    ...
    if type(player) == str and player not in ["white", "black"]:
        raise ValueError
...
print(get_starting_pos_test("white"))
print(get_starting_pos_test("black"))
print(get_starting_pos_test2("white"))
print(get_starting_pos_test2("black"))
